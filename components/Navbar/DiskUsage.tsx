      ...
      {usage && (
        <div className="text-center">
          <div className="flex h-2 bg-el1">
            <Usage
              label="Roms"
              percentage={usage.roms / sum}
              className="bg-el2Accent rounded-l-md"
            />
            <Usage
              label="States"
              percentage={usage.states / sum}
              className="bg-redColor rounded-r-md"
            />
          </div>
...
function Usage({ label, percentage, className }: UsageProps) {
  return (
    <div style={{ width: percentage * 100 + "%" }} className={"group relative h-2 " + className}>
